...
> An example client and server showcasing FeathersJS offline realtime support for own-data and own-net protocols as described in the docs [here](https://docs.feathersjs.com/guides/offline-first/readme.html).
